      ...
      <>
         {['md'].map((expand) => (
            <Navbar key={expand} expand={expand} 
               ...
               style={{backgroundColor: "#ff5555", boxShadow: "0 1px 6px 2px rgba(10, 10, 10, .6)", zIndex: "99"}}
            >
                           ...
                           <Nav className="justify-content-end flex-grow-1 fs-5 pe-0">
                              <Dropdown>
                                 <DropdownToggle variant='' className="pt-0 position-relative px-0" style={{border: "1px solid #ff5555", height: "60px"}}>
                                    <div className='rounded-pill mb-0' style={{border: "1px solid #ff5555", marginTop: "-1px"}}>
                                 ...
                                 >
                                    <Dropdown.Item className='fs-5 mb-3' style={{width: "220px"}}>
